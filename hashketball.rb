...
def num_points_scored (player_name)
  game_hash.each do |team_location, team_data|
    team_data.each do |team_datum, players|
      if team_datum == :players && players.include?(player_name)
...
def team_names
  game_hash.collect do |team_location, team_data|
    team_data.select { |team_datum, team_name| team_datum == :team_name }.values.first
  end
end

def player_numbers (given_team_name)
  game_hash.each do |team_location, team_data|
    team_data.each do |team_datum, team_name|
